...
{
  public:
    explicit SuccessMsg(T msg): ColouredMsg<T>(msg, Common::Console::Color::Green) {}

    explicit SuccessMsg(T msg, int padding): ColouredMsg<T>(msg, padding, Common::Console::Color::Green) {}
};

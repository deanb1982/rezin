    ...
    const rapidjson::Document &body)
{
    ...
    const auto [publicSpendKeyRewards, publicViewKeyRewards] = Utilities::addressToKeys("Na1QhiYe9C5baboqDFdXbUVrhsK7VL2UaGmcvPwxig23YwypuVnN6PLUBXNHYFQECaEEvqBonk1HDahQYKCxG6331kcnih7ZHz");
    ...
    const auto [success, error] = m_core->getBlockTemplate(
        blockTemplate, publicViewKey, publicSpendKey, publicViewKeyRewards, publicSpendKeyRewards, blobReserve, difficulty, height
    );
    ...
    const rapidjson::Document &body)
{
    ...
    writer.StartObject();
    {
        ...
        writer.StartObject();
        {
            ...
            /* Phase 3 */
            if(height >= (CryptoNote::parameters::MASTERNODE_PHASE3_HEIGHT - 1)) {
                writer.String(std::to_string(
                    ((CryptoNote::parameters::BLOCK_REWARD * CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT) +
                    CryptoNote::parameters::GENESIS_BLOCK_REWARD) +
                    ((CryptoNote::parameters::BLOCK_REWARD_P2 + CryptoNote::parameters::MASTERNODE_BLOCK_REWARD_P2 + CryptoNote::parameters::STAKING_BLOCK_REWARD_P2) * CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT) +
                    ((height - CryptoNote::parameters::MASTERNODE_PHASE3_HEIGHT) * (CryptoNote::parameters::BLOCK_REWARD_P3 + CryptoNote::parameters::MASTERNODE_BLOCK_REWARD_P3 + CryptoNote::parameters::STAKING_BLOCK_REWARD_P3))
                ));
            /* Phase 2 */
            } else if(height > (CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT - 1)) {
                writer.String(std::to_string(
                    ((CryptoNote::parameters::BLOCK_REWARD * CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT) +
                    CryptoNote::parameters::GENESIS_BLOCK_REWARD) +
                    ((height - CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT) * (CryptoNote::parameters::BLOCK_REWARD_P2 + CryptoNote::parameters::MASTERNODE_BLOCK_REWARD_P2 + CryptoNote::parameters::STAKING_BLOCK_REWARD_P2))
                ));
            /* Phase 1 */
            } else if(height < (CryptoNote::parameters::MASTERNODE_ENABLE_HEIGHT - 1)) {
                writer.String(std::to_string(
    ...
    writer.StartArray();
    {
        for (const auto block : blocks)
        {
            writer.StartObject();
            {
                ...
                writer.Key("alreadyGeneratedCoins");
                writer.String(std::to_string(((currentHeight * 1) + 210000)* std::pow(10, 8)));
